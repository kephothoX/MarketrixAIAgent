import mimetypes, requests, base64, uuid
import gradio as gr
...
def get_response_from_llm_backend(
    ...
    payload = AgentRequest(text=message["text"], files=image_data)
        ...
        if result.thinking_process:
            chat_responses.append(
                gr.ChatMessage(
                    ...
                    metadata={"title": "🧠 Generating Response"},
                )
            )
...
if __name__ == "__main__":
    ...
    app.launch(server_name="127.0.0.1", server_port=8080, share=True)
